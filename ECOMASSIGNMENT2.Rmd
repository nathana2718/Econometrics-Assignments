...
Similarly, $\sigma$ appears to have limited effect on coverage rate. Higher standard deviation appears to slightly negatively affect coverage rate though the effect is again quite minute.  The number of samples also seems to not have any effect - coverage rate appears to be uniform across n. 
...
Bias is expected disappear as condition 1 is removed. There may be higher standard deviation than question one still as the variance of $\beta$ can be calculated like so:
